...
class TrunkDegree:
    ...
    def trunk_plane(self):
        m_body_number = utils.body_part_number()
    ...
    def trunk_flex_calculator(self):
        ...
        trunk_flex = utils.get_angle_between_degs(z_vector, normal_plane) - 90
        return trunk_flex
    ...
    def trunk_side_calculator(self):
        ...
        trunk_side_bending = utils.get_angle_between_degs(z_vector, project_spine_on_xz_plane)
    ...
    def trunk_twist_calculator(self):
        ...
        rotor = utils.find_rotation_quaternion(q1, q2)
