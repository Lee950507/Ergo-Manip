...
class LADegrees:
    ...
    def lower_arm_degree(self):
        ...
        right_degree = utils.get_angle_between_degs(right_shoulder_elbow_vector, right_elbow_wrist_vector)
        left_degree = utils.get_angle_between_degs(left_shoulder_elbow_vector, left_elbow_wrist_vector)
