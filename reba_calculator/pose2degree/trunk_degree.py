...
import reba_calculator.pose2degree.body_part_sorting as bodyNum
import reba_calculator.pose2degree.Util as Util
...
class TrunkDegree:
    ...
    def trunk_flex_calculator(self):
        ...
        trunk_flex = Util.get_angle_between_degs(z_vector, normal_plane) - 90
        return trunk_flex
    ...
    def trunk_side_calculator(self):
        ...
        trunk_side_bending = Util.get_angle_between_degs(z_vector, project_spine_on_xz_plane)
