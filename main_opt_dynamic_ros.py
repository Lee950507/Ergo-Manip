...
def draw_skeleton_and_robot(global_positions, skeleton_parent_indices, robot_left_pose, robot_right_pose, object_pose, q_r, q_l):
    ...
    plt.savefig(f'/home/curi/Chenzui/Ergo-Manip/data/fig/{timestamp}.png', dpi=300, bbox_inches='tight', transparent=True)
...
def multi_callback(subscriber_shouL, subscriber_shouR, subscriber_elbowL, subscriber_elbowR, subscriber_wristL, subscriber_wristR):
...
if __name__ == '__main__':
    ...
    try:
        ...
        # subscriber_object = message_filters.Subscriber('/vrpn_client_node/object/pose', PoseStamped)
        ...
        sync = message_filters.ApproximateTimeSynchronizer(
            [subscriber_shouL, subscriber_shouR, subscriber_elbowL, subscriber_elbowR, subscriber_wristL, subscriber_wristR], 10, 1)
        print("Here we go!!!")
